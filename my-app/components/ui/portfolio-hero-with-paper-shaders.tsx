  ...
  return (
    <div className="relative min-h-screen overflow-hidden flex">
      ...
      >
        ...
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-lg font-normal mb-8">Sam.cv</h1>
          <div className="mb-8">
            <h2 className="text-lg font-normal">Sam</h2>
            <h3 className="text-lg font-normal">DEV</h3>
          </div>
        </div>
        ...
        <div className="mb-12 space-y-1">
          <div className="flex">
            <span className="w-20">KIA Hyundai</span>
            <span className="mx-2">Intern</span>
            <span className="mx-4">2025 → ....</span>
          </div>
          <div className="flex">
            <span className="w-20">Depix</span>
            <span className="mx-2">Intern</span>
            <span className="mx-4">2024 → 2025</span>
          </div>
          <div className="flex">
            <span className="w-20">McGill</span>
            <span className="mx-2">Research Intern </span>
            <span className="mx-4">2024 → 2025</span>
          </div>
          <div className="flex">
